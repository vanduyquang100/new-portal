...
public class StudentGradesServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        getStudentGrades(request, response);
    }

    private void getStudentGrades(HttpServletRequest request, HttpServletResponse response)  {
        try {
            ...
            ArrayList<StudentGrade> grades = database.getStudentGrades(student, year);
            // set the list of students as a request attribute
            request.setAttribute("student", student);
            request.setAttribute("grades", grades);

            // forward the request to the student list JSP
            RequestDispatcher dispatcher = request.getRequestDispatcher("/views/studentGrades.jsp");
